...
const page = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(api.article.update(id), submitFormData, {
    ...
    useEffect(() => {
        return () => { if (imagePreview && typeof imagePreview === 'string' && imagePreview.startsWith('blob:')) URL.revokeObjectURL(imagePreview); };
    }, [imagePreview]);
                                ...
                                <div>
                                    <motion.h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                                        <motion.span animate={{ rotate: [0, -10, 10, 0] }} transition={{ duration: 0.6, delay: 0.3 }}>
                                            <FaPen className="w-7 h-7 text-blue-600" />
                                        </motion.span>
                                        Update Article
                                    </motion.h1>
                                    <motion.p variants={fadeUp} className="text-gray-600 mt-2">Edit and improve your published article</motion.p>
                                </div>
                                <motion.div whileHover={{ rotate: 180 }} transition={{ duration: 0.4 }}>
                                    <FaPen className="w-10 h-10 text-blue-200" />
                                </motion.div>
                            </motion.div>
                            ...
                            <motion.form variants={stagger} className="space-y-8" onSubmit={handleSubmit}>
                                ...
                                <motion.div variants={fadeUp} id="title" className="space-y-2">
                                    <label htmlFor="title" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                        <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse"></span> Title *
                                    </label>
                                ...
                                <motion.div variants={fadeUp} id="author" className="space-y-2">
                                    <label htmlFor="author" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                        <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse"></span> Author *
                                    </label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <motion.div variants={fadeUp} id="image" className="space-y-2">
                                    <label htmlFor="image" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                        <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse"></span> Featured Image
                                    </label>
                                    <div className="mt-1 space-y-4">
                                        ...
                                        >
                                            <div className="flex flex-col items-center justify-center pt-8 pb-6 px-4 text-center">
                                                ...
                                                <div className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors cursor-pointer flex items-center gap-2">Select Image</div>
                                            </div>
                                        </motion.div>
                                        <AnimatePresence>
                                            {(imagePreview) && (
                                ...
                                <motion.div variants={fadeUp} id="content" className="space-y-2">
                                    <label htmlFor="content" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                        <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse"></span> Content *
                                    </label>
                                    <div className="relative">
